namespace SecretCellar
{
	partial class frmSuspendedTransactionsNamePopUp
	{
		...
		private void InitializeComponent()
		{
			...
			// btnOkay
			// 
			this.btnOkay.Location = new System.Drawing.Point(110, 69);
			...
			this.label1.Text = "Name the transaction to be suspended";
			...
			this.label2.Text = "Name the transaction to be suspended:";
